...
const EventDetails = () => {
  ...
  const handleTicketClick = (ticket) => {
    navigate("/select-ticket", { state: { ticket } });
  };
      ...
      {tickets.length > 0 ? (
        <div className="grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-4 mt-6 border-red-300">
          {tickets.map((ticket) => (
            <div
              key={ticket._id}
              className="max-w-md mx-auto bg-white rounded-xl shadow-1xl overflow-hidden md:max-w-4xl mb-4 border-2"
            >
                ...
                <div className="p-8 flex-grow">
                  ...
                  <div className="flex justify-between items-center mt-4">
                    ...
                    <button
                      ...
                      className="bg-blue-500 text-white px-10 py-1 rounded-xl hover:bg-blue-900"
                    >
                      Ticket
                    </button>
                  </div>
