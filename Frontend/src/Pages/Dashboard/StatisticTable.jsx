...
const Statistics = () => {
  ...
  <div className="w-full sm:w-1/3 p-3">
    ...
    <Card className="h-52 rounded-full bg-blue-200 hover:bg-blue-300 transition duration-300 flex items-center justify-center">
  ...
  <div className="w-full sm:w-1/3 mt-4 sm:mt-0 p-3">
    <Card className="h-52 rounded-full bg-gray-700 hover:bg-gray-300 transition duration-300 flex items-center justify-center">
      <div className="rounded-full bg-white p-2">
  ...
  <div className="w-full sm:w-1/3 mt-4 sm:mt-0 p-3">
    <Card className="h-52 rounded-full bg-green-200 hover:bg-green-300 transition duration-300 flex items-center justify-center">
      <div className="rounded-full bg-white p-2">
